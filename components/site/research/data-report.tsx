    ...
    <>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              ...
              <p>시장별로 보면 이 구조가 더 분명하다. 일본(한류 45, 외교 12), 한국(한류 42, 외교 19)만 한류가 압도한다. 반면 브라질(한류 49, 외교 62), 독일(한류 17, 외교 34), 아랍권(한류 46, 외교 47), 미국·인도(한류 56, 외교 67), 인도네시아(한류 53, 외교 56) 등 나머지 6개 시장은 외교가 한류와 같거나 크다.</p>
            ...
            <>
              ...
              <p>The pattern sharpens by market. Only Japan (Hallyu 45, Diplomacy 12) and Korea (Hallyu 42, Diplomacy 19) are Hallyu-dominant. The remaining 6 markets &mdash; Brazil (49 vs 62), Germany (17 vs 34), the Arab world (46 vs 47), the US and India (56 vs 67), Indonesia (53 vs 56) &mdash; all see diplomacy match or exceed Hallyu.</p>
      ...
      <DocSection tint>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              <p>한국을 처음 떠올리면 K-pop, 드라마, 뷰티를 예상하기 쉽다. 그러나 8개 시장 중 6개에서 외교가 한류보다 크거나 같다.</p>
              <p>독일: 외교 34, 한류 17. 두 배다. 브라질: 외교 62, 한류 49. 인도네시아: 외교 56, 한류 53. 아랍권: 외교 47, 한류 46. 미국: 외교 67, 한류 56. 인도: 외교 67, 한류 56.</p>
              <p>미국과 인도마저도 한류보다 외교 질문이 많다. 한류의 최대 소비 시장인 미국에서도, 검색창에서는 분단이 더 많이 등장한다.</p>
              <p>한류가 우세한 시장은 일본과 한국뿐이다. 일본의 외교 비중은 12개로, 한류(45)의 1/4에 불과하다. 한국도 한류(42)가 외교(19)를 앞선다. 이 두 시장은 한국을 일상적으로 경험하는 국가다.</p>
              <p>나머지 6개 시장에게 한국은 문화 국가 이전에 분단 국가다. 한류가 관심을 만들었다는 사실과 한국이 여전히 지정학적 국가로 읽힌다는 사실이 동시에 존재한다.</p>
            </>
          ) : (
            <>
              <p>When people think of Korea, they expect K-pop, drama, beauty. But in 6 of 8 markets, diplomacy matches or exceeds Hallyu.</p>
              <p>Germany: Diplomacy 34, Hallyu 17 &mdash; double. Brazil: 62 vs 49. Indonesia: 56 vs 53. Arab world: 47 vs 46. United States: 67 vs 56. India: 67 vs 56.</p>
              <p>Even the US and India &mdash; Hallyu&apos;s largest consumption markets &mdash; show more diplomacy questions than Hallyu questions in their search data.</p>
              <p>Only Japan and Korea show Hallyu dominance. Japan&apos;s diplomacy share is just 12 &mdash; a quarter of Hallyu (45). These are countries that experience Korea daily.</p>
      ...
      <DocSection>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              <p>일본 질문은 한류에 집중되지 않는다. 음식, 예절, 언어, 생활문화, 역사, 관광이 고르게 퍼져 있다. 8개 시장 중 주제 분포가 가장 균등한 시장이다.</p>
            ...
            <>
              <p>Japan&apos;s questions do not concentrate on Hallyu. Food, etiquette, language, daily culture, history, and tourism spread evenly. Of all 8 markets, Japan has the most balanced topic distribution.</p>
      ...
      <DocSection tint>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              <p>독일은 8개 시장 중 유일하게 언어가 1위인 시장이다. 71개 질문으로, 2위 외교(34)의 두 배를 넘는다. 다른 어떤 시장에서도 이런 패턴은 나타나지 않는다.</p>
              ...
              <p>다른 국가와 비교하면 차이가 분명하다. 미국·인도는 &ldquo;is Korean hard to learn for English speakers&rdquo;를 묻는다. 실용이다. 인도네시아는 &ldquo;bahasa korea translate&rdquo;를 묻는다. 도구다. 일본은 &ldquo;韓国語翻訳&rdquo;을 묻는다. 사용이다.</p>
            ...
            <>
              ...
              <p>Compare with other markets. The US and India ask &ldquo;Is Korean hard to learn for English speakers?&rdquo; &mdash; practical. Indonesia asks &ldquo;bahasa korea translate&rdquo; &mdash; utilitarian. Japan asks &ldquo;Korean translation&rdquo; &mdash; usage.</p>
      ...
      <DocSection>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              <p>한국 시장의 1위 주제는 사회(49개)다. 여기까지는 미국·인도(각 사회 111개)와 비슷해 보인다.</p>
              ...
              <p>이 차이는 8개 시장 중 한국에서만 나타난다. 일본은 한국 사회의 작동 방식을 묻고, 독일은 한국어의 구조를 묻고, 인도네시아는 한국이 어떤 나라인지를 묻는다. 한국만 &ldquo;한국이 어떻게 보이는지&rdquo;를 묻는다.</p>
              <p>1,540개 질문은 한국이 가장 자의식적인 시장임을 보여준다.</p>
            </>
          ) : (
            <>
              <p>Korea&apos;s top topic is society (49 questions). At first glance, this looks similar to the US and India (society, 111 each).</p>
              <p>But the content is entirely different. US and India society questions ask about phenomena: &ldquo;Why do Koreans get plastic surgery?&rdquo; &ldquo;Why is Korea&apos;s suicide rate high?&rdquo; Korean society questions ask about image: &ldquo;How do foreigners see Koreans?&rdquo; &ldquo;What are Korean characteristics?&rdquo;</p>
              <p>Other countries try to understand Korea. Korea tries to verify how it is being understood.</p>
              <p>This difference appears only in Korea among all 8 markets. Japan asks how Korean society works. Germany asks how Korean language is structured. Indonesia asks what kind of country Korea is. Only Korea asks how Korea looks.</p>
      ...
      <DocSection tint>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              <p>아랍권은 8개 시장 중 가장 집중도가 높은 시장이다. 전체 141개 질문 중 외교(47)와 한류(46)가 전체의 66%를 차지한다. 나머지 6개 주제는 34%를 나눈다.</p>
            ...
            <>
              <p>The Arab world is the most concentrated market of all 8. Of 141 total questions, diplomacy (47) and Hallyu (46) together account for 66%. The remaining 6 topics share 34%.</p>
      ...
      <DocSection>
        ...
        <H2>
          {locale === "ko"
            ? "미국과 인도는 한국을\n가장 넓게 소비한다"
            : "The US and India\nconsume Korea most broadly"}
        </H2>
        <Prose>
          {locale === "ko" ? (
            <>
              <p>미국과 인도는 각각 466개 질문으로 가장 큰 시장이다. 두 시장은 같은 영어 검색어를 사용하므로 질문이 100% 동일하다. 그런데 더 중요한 것은 양이 아니라 분포다.</p>
              <p>사회 24%, 한류 20%, 외교 15%, 관광 14%, 언어 9%, 역사 9%, 경제 6%, 기술 4%. 8개 주제가 모두 의미 있는 비중을 가진다. 1위 사회(111)와 8위 기술(19) 사이에 6배 차이밖에 나지 않는다.</p>
              <p>이것은 다른 시장과 비교하면 이례적이다. 독일은 1위(언어 71)와 3위(사회 17) 사이에 4배 차이가 난다. 아랍권은 하위 6개 주제가 전체의 34%에 불과하다. 미국과 인도만 모든 주제가 고르게 분포한다.</p>
              <p>왜 이 두 시장만 이런가. 영어는 특정 국가의 언어가 아니라 글로벌 정보 접근 언어이기 때문이다. 영어로 한국을 검색하는 사람은 특정 관심사가 아니라 한국에 대한 모든 종류의 관심사를 가지고 들어온다.</p>
              <p>미국과 인도는 가장 깊은 시장이 아니다. 가장 넓은 시장이다. 한국에 대한 가장 다양한 질문이 발생하는 곳이지만, 특정 방향으로 깊이 들어가는 시장은 아니다.</p>
            </>
          ) : (
            <>
              <p>The US and India are each the largest market at 466 questions. They use the same English search terms, so their question sets are 100% identical. But what matters more than volume is distribution.</p>
              ...
              <p>This is unusual compared to other markets. Germany&apos;s gap between #1 (Language, 71) and #3 (Society, 17) is 4x. The Arab world&apos;s bottom 6 topics account for just 34%. Only the US and India distribute evenly across all topics.</p>
              <p>Why only these two? Because English is not a single country&apos;s language &mdash; it is a global information-access language. People searching Korea in English bring every kind of interest, not a specific one.</p>
              <p>The US and India are not the deepest markets. They are the broadest. They generate the widest variety of questions about Korea, but do not go deep in any single direction.</p>
            </>
          )}
        </Prose>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              ...
              <p>미국·인도의 한류 질문은 가장 다양하다. 음식, 뷰티, 드라마, K-pop이 고르게 분포한다. 특정 장르 팬덤이 아니라 콘텐츠 전반의 소비다.</p>
            ...
            <>
              ...
              <p>US and India Hallyu questions are the most diverse. Food, beauty, drama, K-pop distribute evenly. Not genre fandom &mdash; broad content consumption.</p>
        ...
        <div className="mt-6 rounded-xl border border-border bg-white p-5">
          ...
          <div className="space-y-2">
            {[
              ...
              { market: D("미국", "US"), role: D("콘텐츠 전반 소비", "Broad content consumption"), q: D("음식·뷰티·드라마·K-pop 균등", "Food, beauty, drama, K-pop even") },
              { market: D("인도", "India"), role: D("콘텐츠 전반 소비", "Broad content consumption"), q: D("음식·뷰티·드라마·K-pop 균등", "Food, beauty, drama, K-pop even") },
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              ...
              <p>미국·인도는 &ldquo;is Korean hard to learn for English speakers&rdquo;를 묻는다. 자신의 언어를 기준으로 비교한다.</p>
            ...
            <>
              ...
              <p>The US and India ask &ldquo;Is Korean hard to learn for English speakers?&rdquo; &mdash; comparing against their own language.</p>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              ...
              <p>미국·인도는 시작부터 사회다. 한류를 건너뛰고 &ldquo;한국인은 왜 성형을 하는가&rdquo; &ldquo;한국의 자살률은 왜 높은가&rdquo;를 곧바로 묻는다.</p>
            ...
            <>
              ...
              <p>The US and India start at society. Skipping Hallyu entirely, they ask directly: &ldquo;Why do Koreans get plastic surgery?&rdquo; &ldquo;Why is the suicide rate high?&rdquo;</p>
        ...
        <Prose>
          {locale === "ko" ? (
            <>
              ...
              <p>미국은 광역형이다. 가장 넓은 질문 분포를 가지지만 특정 방향으로 깊이 들어가지 않는다.</p>
            ...
            <>
              ...
              <p>The US is the broad type. The widest question distribution, but no deep single-direction exploration.</p>
              <p>India is the broad type. Using the same English search terms as the US, it shows the same even distribution.</p>
